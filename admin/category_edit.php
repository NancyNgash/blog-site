                   ...
                   <form action="update_user.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
                     ...
                     <div class="col-md-6 mb-3">
               			 	...
               			 	<input type="text" name="meta_title" max="100" value="<?=$row['meta_title'] ?>" required class="form-control">	
               		   </div>
                     <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                     ...
                     <div class="col-md-6 mb-3">
                        <label for="">Status</label>
               			 ...
               			 <div class="col-md-6 mb-3">
               			 	<button type="submit" name="edit_category" class="btn btn-primary"> Save Category</button>
               			 </div>
                	</div>
                </div>
              </div>
